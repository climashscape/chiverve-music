...
dd
  ...
  div
    ...
    .gap-top(v-if="!isLinux" data-setting-key="desktopLyric.isHoverHide")
      ...
      common-setting-help-icon(:text="$t('setting__desktop_lyric_hover_hide_tip')" :label="$t('setting__desktop_lyric_hover_hide')")
    ...
    .gap-top(data-setting-key="desktopLyric.pauseHide")
      ...
      common-setting-help-icon(:text="$t('setting__desktop_lyric_pause_hide_tip')" :label="$t('setting__desktop_lyric_pause_hide')")
    ...
    .gap-top(data-setting-key="desktopLyric.isDelayScroll")
      ...
      common-setting-help-icon(:text="$t('setting__desktop_lyric_delay_scroll_tip')" :label="$t('setting__desktop_lyric_delay_scroll')")
    //- 仅垂直模式（direction=vertical）下参与布局：当前行滚到顶部还是居中
    div.gap-top(data-setting-key="desktopLyric.scrollAlign")
      .p.small
        | {{ $t('setting__desktop_lyric_scroll_align') }}
        common-setting-help-icon(:text="$t('setting__desktop_lyric_scroll_align_tip')" :label="$t('setting__desktop_lyric_scroll_align')")
      div
