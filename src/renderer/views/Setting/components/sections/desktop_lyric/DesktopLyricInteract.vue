...
dd
  ...
  div
    ...
    .gap-top(data-setting-key="desktopLyric.pauseHide")
      ...
      svg-icon(class="help-icon" name="help-circle-outline" :aria-label="$t('setting__desktop_lyric_pause_hide_tip')" :title="$t('setting__desktop_lyric_pause_hide_tip')")
    ...
    .gap-top(data-setting-key="desktopLyric.isDelayScroll")
      ...
      svg-icon(class="help-icon" name="help-circle-outline" :aria-label="$t('setting__desktop_lyric_delay_scroll_tip')" :title="$t('setting__desktop_lyric_delay_scroll_tip')")
    ...
    div.gap-top(data-setting-key="desktopLyric.scrollAlign")
      .p.small
        ...
        svg-icon(class="help-icon" name="help-circle-outline" :aria-label="$t('setting__desktop_lyric_scroll_align_tip')" :title="$t('setting__desktop_lyric_scroll_align_tip')")
      div
