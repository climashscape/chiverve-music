...
dd
  ...
  div
    ...
    .gap-top(data-setting-key="player.startupAutoPlay")
      ...
      svg-icon(class="help-icon" name="help-circle-outline" :aria-label="$t('setting__play_startup_auto_play_tip')" :title="$t('setting__play_startup_auto_play_tip')")
    ...
    .gap-top(data-setting-key="player.powerSaveBlocker")
      ...
      svg-icon(class="help-icon" name="help-circle-outline" :aria-label="$t('setting__play_power_save_blocker_tip')" :title="$t('setting__play_power_save_blocker_tip')")
    ...
    .gap-top(data-setting-key="player.isSavePlayTime")
      ...
      svg-icon(class="help-icon" name="help-circle-outline" :aria-label="$t('setting__play_save_play_time_tip')" :title="$t('setting__play_save_play_time_tip')")
    ...
    .gap-top(data-setting-key="player.autoSkipOnError")
      ...
      svg-icon(class="help-icon" name="help-circle-outline" :aria-label="$t('setting__play_auto_skip_on_error_tip')" :title="$t('setting__play_auto_skip_on_error_tip')")
</template>
